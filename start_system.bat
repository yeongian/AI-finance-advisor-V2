...
chcp 65001 >nul
echo ================================================
echo AI Finance Advisor - System Start
echo ================================================
echo.
...
echo.
echo ================================================
echo OK System services started successfully!
echo ================================================
echo.
echo Access URLs:
...
echo.
echo TIP: System services are running in the same CMD window.
