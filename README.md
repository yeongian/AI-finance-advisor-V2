...
│   │   ├── enhanced_agent.py # 향상된 에이전트
│   │   └── advanced_tool_agent.py # 고급 도구 에이전트
│   ├── api/                  # FastAPI 백엔드
│   │   ├── main.py           # API 메인 서버
│   │   ├── enhanced_endpoints.py # 향상된 API 엔드포인트
│   │   ├── langgraph_endpoints.py # LangGraph API
│   │   └── advanced_tool_endpoints.py # 고급 도구 API
│   ├── core/                 # 핵심 기능
│   │   ├── config.py         # 설정 관리
│   │   └── utils.py          # 유틸리티 함수
│   ├── rag/                  # RAG 시스템
...
│   └── ui/                   # Streamlit UI
│       ├── streamlit_app.py  # 기본 Streamlit 앱
│       ├── enhanced_streamlit.py # 향상된 UI
│       ├── langgraph_streamlit.py # LangGraph UI
│       └── advanced_tool_streamlit.py # 고급 도구 UI
├── data/                     # 데이터 파일
